Django Angularjs AngularMaterial Login Authentication is a minimal sample application for login into your web project using angularjs and angularmaterial for frontend and backend as Django python 
